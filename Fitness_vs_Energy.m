load('results/workspace/14_0.0001_1122.mat')
...
if conserve == 1
    Energy1 = Calculate_Energy(test1_seq_bin, J_MPF_BML,H);
else 
    Energy1 = Calculate_Energy(test1_seq_bin, J_MPF_BML);
end

fitness1 = [63506, 93719]';
...
Energy4_approx = [Energy4(1:2)'  Energy4(3) Energy4(4)  Energy4(7)  Energy4(8) ]' ;
...
fitness4_approx = [fitness4(1:2)'  fitness4(3) fitness4(4)  fitness4(7)  fitness4(8)]' ; 
